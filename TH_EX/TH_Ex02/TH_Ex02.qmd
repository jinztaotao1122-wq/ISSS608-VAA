...
.mc-figure-card img {
  ...
  box-shadow: 0 18px 40px rgba(23, 36, 47, 0.10);
}
...
.mc-wide-figure img {
  ...
  border: 1px solid #e8eef0;
  margin-bottom: 1rem;
  box-shadow: 0 24px 52px rgba(23, 36, 47, 0.12);
}
...
### Escalation pressure over time

<figure class="mc-wide-figure mc-figure-card">
  <img src="figures/figure_5_pressure_timeline.png" alt="Escalation pressure across the investigation window">
  <span class="mc-mini-label">Figure 1</span>
  <h3>Escalation pressure and channel mix across the full investigation window</h3>
  <p>
    This chart shows why the final leak should not be treated as a single isolated post. Communication volume
    intensifies as the story matures, and the internal mix shifts from routine huddles into increasingly dense
    one-to-one and side-huddle coordination. The 29 May slip, the 30 May installation of Judge, and the 5 June
    breach-hour spike appear as part of one continuous escalation pattern.
  </p>
</figure>
...
<figure class="mc-wide-figure mc-figure-card">
  <img src="figures/figure_4_breach_timeline.png" alt="Embargo breach causal timeline">
  ...
  <p>
    ...
    confirmation. The breach is not one rogue post. It is the last step in a coordinated release path
    that progressively routes around formal oversight.
  </p>
</figure>

<div class="mc-showcase-grid">
  <figure class="mc-figure-card">
    <img src="figures/figure_6_coordination_network.png" alt="Breach-window coordination network">
    <span class="mc-mini-label">Figure 3</span>
    <h3>Breach-window coordination network</h3>
    <p>
      The decisive coordination is concentrated around a Legal-Social-Platform Trust core, with PR and PR Intern
      pulled in as execution partners. This view makes the human relationships behind the release logic easier to
      see than a simple linear timeline alone.
    </p>
  </figure>
  <figure class="mc-figure-card">
...
<figure class="mc-wide-figure mc-figure-card">
  <img src="figures/figure_7_behavior_drift_heatmap.png" alt="Behavior drift heatmap">
  <span class="mc-mini-label">Figure 5</span>
  <h3>Behavior drift heatmap across actors, phases, and public channels</h3>
  <p>
    This heatmap makes the novelty of the breach behavior immediately visible. Baseline public activity is mostly
    official and concentrated in expected communications roles. On the crisis day, Legal and Platform Trust become
    visible public narrators, while personal and anonymous channels dominate the public signal.
  </p>
</figure>
...
<div class="mc-figure-grid">
  <figure class="mc-figure-card">
    ...
    <span class="mc-mini-label">Figure 6</span>
  ...
  <figure class="mc-figure-card">
    ...
    <span class="mc-mini-label">Figure 7</span>
